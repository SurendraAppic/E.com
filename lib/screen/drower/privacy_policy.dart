...
class Pravaciscreen extends StatefulWidget {
  const Pravaciscreen({super.key});

  @override
  State<Pravaciscreen> createState() => _PravaciscreenState();
}

class _PravaciscreenState extends State<Pravaciscreen> {
  @override
